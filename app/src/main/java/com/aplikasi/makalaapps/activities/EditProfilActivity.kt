...
class EditProfilActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        et_alamt.setText(GlobalData.alamat)
    ...
    private fun editUser() {
        if (validateUserProfilDetails()) {
            ...
            val strRequest = StringRequest(Request.Method.GET, registerUrl + "?first_name="
                    ...
                    "&email=" + et_email.text.toString() + "&phone=" + et_phone.text.toString()
                    + "&gender=" + GlobalData.gender + "&alamat=" + GlobalData.alamat, { response ->
    ...
    fun updateUserProfil() {
        ...
        GlobalData.alamat = et_alamt.text.toString()
