...
class RegisterActivity : BaseActivity() {
    ...
    private fun registerUser(){
        if(validateRegisterDetails()){
            ...
            val strRequest = StringRequest(Request.Method.GET, registerUrl + "?first_name=" +
                    et_nama_depan.text.toString() + "&last_name=" + et_nama_belakang.text.toString() +
                    "&email=" + et_email.text.toString() + "&password=" + et_kata_sandi.text.toString()
                    + "&password_konfirmasi=" + et_konfirmasi_kata_sandi.text.toString(), { response ->
